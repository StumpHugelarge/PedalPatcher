...
export async function loadPedalLibrary(): Promise<LibraryPedal[]> {
  ...
  // BASE_URL carries the deploy subpath (e.g. "/PedalPatcher/" on GitHub
  // Pages project pages) — a hardcoded "/data/..." would 404 there even
  // though it works fine when served from a domain root.
